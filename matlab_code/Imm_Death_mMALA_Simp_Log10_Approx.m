function [ ] = Imm_Death_mMALA_Simp_Log10_Approx( y, Time, k1, k2 )
...
CurTime = fix(clock);
save(['Results_mMALA_Simp_ApproxL_' num2str(floor(now)) '_' num2str(CurTime(4:6)) '.mat'], 'betaPosterior', 'LJLSaved', 'TimeTaken')
